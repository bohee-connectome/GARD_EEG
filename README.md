...
Subjects:         ~2,663 subjects (based on Excel metadata)
                  * Note: Excel list is incomplete, actual number may be higher
...
Columns:          측정년도, k_no, object_idx (OID), Gender, Birth, Age,
                  Device, Device_ID, BEAM파일명, Sensory파일명, Attention파일명
