...
#SBATCH -o logs/gard_fullft_%j.out
#SBATCH -e logs/gard_fullft_%j.err
#SBATCH -J GARD_FullFT

###############################################################################
# GARD Full Finetuning Script (No LoRA)
###############################################################################
...
OUTPUT_PARENT_DIR="/pscratch/sd/b/boheelee/GARD/finetuning/${GARD_TASK_NAME}/fullft"
...
for seed in 41 42 43; do
    echo ""
    echo "=================================================="
    echo "Running [Full FT] for GARD with Seed $seed"
    echo "=================================================="
...
echo "✅ All Full Finetuning Complete! → ${OUTPUT_PARENT_DIR}"
