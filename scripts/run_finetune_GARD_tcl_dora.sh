...
#SBATCH -o logs/gard_tcl_dora_%j.out
#SBATCH -e logs/gard_tcl_dora_%j.err
#SBATCH -J GARD_TCL_DoRA

###############################################################################
# GARD TCL + DoRA Finetuning Script
###############################################################################
...
OUTPUT_PARENT_DIR="/pscratch/sd/b/boheelee/GARD/finetuning/${GARD_TASK_NAME}/tcl_dora"
...
for seed in 41 42 43; do
    echo ""
    echo "=================================================="
    echo "Running [TCL + DoRA] for GARD with Seed $seed"
    echo "=================================================="
...
echo "✅ All TCL + DoRA Finetuning Complete! → ${OUTPUT_PARENT_DIR}"
