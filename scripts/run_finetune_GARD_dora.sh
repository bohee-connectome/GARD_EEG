...
#SBATCH -o logs/gard_dora_%j.out
#SBATCH -e logs/gard_dora_%j.err
#SBATCH -J GARD_DoRA

###############################################################################
# GARD DoRA Finetuning Script
###############################################################################
...
OUTPUT_PARENT_DIR="/pscratch/sd/b/boheelee/GARD/finetuning/${GARD_TASK_NAME}/dora"
...
for seed in 41 42 43; do
    echo ""
    echo "=================================================="
    echo "Running [DoRA] for GARD with Seed $seed"
    echo "=================================================="
...
echo "✅ All DoRA Finetuning Complete! → ${OUTPUT_PARENT_DIR}"
